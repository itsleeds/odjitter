...
The goal of this {odjitter} R package is to provide an R interface to the [odjitter](https://github.com/itsleeds/odjitter) Rust crate for processing origin-destination data.
